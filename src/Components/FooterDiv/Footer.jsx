...
const Footer = () => {
  return (
    <div className='footer bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-start justify-center'>
      ...
      <div className='grid'>
        ...
        <div className='grid gap-3'>
          <li className='text-white opacity-[.7] hover:opacity-[1]'>Events</li>
          <li className='text-white opacity-[.7] hover:opacity-[1]'>Promo</li>
          <li className='text-white opacity-[.7] hover:opacity-[1]'>Blogs</li>
          <li className='text-white opacity-[.7] hover:opacity-[1]'>Terms of Service</li>
</div>
</div>
  <div className='grid'>
    <span className='divTitle text-[18px] font-semibold pb-[1.5rem] text-white'>
